...
在本章中,我们将学习使用OpenGL渲染场景时发生的过程和三维图形基本渲染过程.如果你习惯于旧版本的OpenGL,也就是固定的函数管道,你可能会在本章结束时想知道为什么它需要如此复杂.你可能会认为,只是在屏幕上画一个简单的形状完全不需要那么多的概念和代码.让我给你们这些有这种想法的人一个建议.它实际上更简单、更灵活.你只需要给它一个机会:现代的OpenGL让你一次只思考一个问题,它让你以一种更有逻辑的方式组织你的代码和进程.
