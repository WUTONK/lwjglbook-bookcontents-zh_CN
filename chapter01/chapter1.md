...
LWJGL 是一个像 OpenGL 的包装器的底层 API.如果您想在短时间内开始制作 3D 游戏的话, 或许您应当考虑其他的 API,比如 \[JmonkeyEngine\]. 要使用这些底层API, 您将需要理解许多概念并写下许多代码来获得你想要的结果, 这样做的好处就是, 您将会更好地理解与掌握 3D 图形系统.
